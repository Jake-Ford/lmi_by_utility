...
tot_ny_pop <- sum(ca_tracts$estimate)
...
datatable(temp, caption = "Henry and Mercer 80% AMI LMI Population, Sources: ACS 2019 and HUD CHAS")%>%
  ...
  formatCurrency('Total_Pop',currency = "", interval = 3, mark = ",", digits = 0)formatCurrency('LMI',currency = "", interval = 3, mark = ",", digits = 0) %>%
